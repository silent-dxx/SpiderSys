...
#start_url="http://yxpjwnet.vip/xiurenwang/2017/0807/3715.html"
#start_url="http://yxpjwnet.vip/luyilu/2017/0818/3761.html"
...
pic_headers = {
	...
	'Connection': 'keep-alive',
	'DNT': '1',
	'Host': 'www.images.zhaofulipic.com:8819',
	'Referer': 'http://52zfl.net/luyilu/2018/0219/4706.html',
	'Pragma': 'no-cache',
	'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.101 Safari/537.36',
}
...
def GetSavePath():
	save_path = sys.path[0] + '\\52zfl'
	return save_path

def LoadConfDoc():
	return  '52zfl.net web splider'
